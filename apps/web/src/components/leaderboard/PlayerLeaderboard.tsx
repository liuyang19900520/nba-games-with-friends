...
export function PlayerLeaderboard({ stats }: PlayerLeaderboardProps) {
  ...
  // Sort stats based on selected sort category (descending order)
  const sortedStats = useMemo(() => {
    const sorted = [...stats].sort((a, b) => {
      const valueA = getStatValue(a, selectedSort);
      const valueB = getStatValue(b, selectedSort);
